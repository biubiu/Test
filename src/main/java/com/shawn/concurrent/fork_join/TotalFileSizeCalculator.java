...
public class TotalFileSizeCalculator {
    public static void main(final String[] args) throws Exception {
        ...
        // TotalFileSizeSequential().getTotalSizeOfFilesInDir(new
        // File(args[0]));
        // final long total = new
        // ConcurrentTotalFileSize().getTotalSizeOfFilesInDir(new
        // File(args[0]));
...
class ForkRecursiveFileSize {
    ...
    public static class FileSizeFinder extends RecursiveTask<Long> {
        ...
        private static final long serialVersionUID = 8248272625395506619L;
        final File file;
