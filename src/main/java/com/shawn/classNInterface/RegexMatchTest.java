...
public class RegexMatchTest {
    ...
    private static final String NAMEREGEX="[\u4e00-\u9fa5]{2,5}";
    private static final String PSDREGEX="^[\\@A-Za-z0-9\\!\\#\\$\\%\\^\\&\\*\\.\\~]{6,16}$";
    private static final String PSDREGEX2 = "^[_A-Za-z0-9\\!\\#\\$\\%\\^\\&\\*\\.\\~]{6,16}$";
    ...
    public static void main(String[] args) {
         ...
         //System.out.println(IsMatch("!@#$%^", PSDREGEX));
         System.out.println(IsMatch(Strings.nullToEmpty("!@#$%^&*"), PSDREGEX));
         String str = "内蒙古";
         String[] locality = str.split("\\s");
         System.out.println(locality[0]);
        }
